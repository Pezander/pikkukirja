...
import { JournalPDF } from "@/components/invoice/JournalPDF";
...
export async function GET(
  ...
  const element = React.createElement(JournalPDF, {
  ...
  const filename = `paivakirja_${association.name.replace(/\s+/g, "_")}_${fy.year}.pdf`;
